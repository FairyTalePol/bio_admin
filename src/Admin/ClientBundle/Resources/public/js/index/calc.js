...
$(document).ready(function() {
  var IMPL_PRICE_CONTROL_EQUIP, IMPL_PRICE_MATERIAL_ACC, IMPL_PRICE_PREMIUM, PRICE_AGROCONSALT, PRICE_CONTROL_EQUIP, PRICE_FIELD_COND, PRICE_MATERIAL_ACC, PRICE_PREMIUM, dollarSignStdEquipStr, dollarSignStdFieldStr, dollarSignStr, implStr;
  ...
  implStr = "Внедрение — $";
  $(".haAmount").on("keyup", function() {
    var implMaterial, implPremium, numInput, priceAgroconsalt, priceFieldCond, priceMaterialAcc, pricePremium;
    numInput = $(this).val() | 0;
    ...
    if (numInput < 100000) {
      ...
      return $('.callus').css('visibility', 'hidden');
    } else {
      ...
      return $('.callus').css('visibility', 'visible');
    }
  });
  return $(".numOfEquip").on("keyup", function() {
    var implPriceEquip, numInput, priceEquip;
    numInput = $(this).val() | 0;
