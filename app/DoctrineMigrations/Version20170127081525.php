...
class Version20170127081525 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('GRANT SELECT ON SEQUENCE public.vermin_categories_id_seq TO bio_group;');
        $this->addSql('GRANT SELECT ON SEQUENCE public.vermins_id_seq TO bio_group;');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('REVOKE SELECT ON SEQUENCE public.vermin_categories_id_seq FROM bio_group;');
        $this->addSql('REVOKE SELECT ON SEQUENCE public.vermins_id_seq FROM bio_group;');
